...
public @interface PropInteger {
    ...
    class PropertyInteger extends PropertyBase<Integer, PropInteger> {
        ...
        public PropertyInteger(Field field, BinnieConfiguration file, ConfigProperty configProperty,
                PropInteger annotedProperty) throws IllegalArgumentException, IllegalAccessException {
