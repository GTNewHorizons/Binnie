...
public @interface PropDouble {
    ...
    class PropertyDouble extends PropertyBase<Double, PropDouble> {
        ...
        public PropertyDouble(Field field, BinnieConfiguration file, ConfigProperty configProperty,
                PropDouble annotedProperty) throws IllegalArgumentException, IllegalAccessException {
