...
public class ConfigurationMachines {
    ...
    @ConfigProperty(
            ...
            comment = { "Modifier that changes how severe splicer/inoculator erros are.",
                    "0 would result in no errors, even for awful serums.",
                    "2.0 would result in twice as severe errors" })
    @PropDouble
    public static double geneticErrorModifier = 1.0;
}
