...
public class ComponentVillageGrove extends StructureVillagePieces.Village {
    ...
    public ComponentVillageGrove(StructureVillagePieces.Start start, int type, Random rand,
    ...
    public static StructureBoundingBox func_74904_a(StructureVillagePieces.Start start, List pieces, Random rand,
            int p_74904_3_, int p_74904_4_, int p_74904_5_, int p_74904_6_) {
        StructureBoundingBox structureboundingbox = StructureBoundingBox
                .getComponentToAddBoundingBox(p_74904_3_, p_74904_4_, p_74904_5_, 0, 0, 0, 3, 3, 3, p_74904_6_);
        return (StructureComponent.findIntersecting(pieces, structureboundingbox) != null) ? null
    ...
    public static ComponentVillageBeeHouse buildComponent(StructureVillagePieces.Start startPiece, List par1List,
        ...
        StructureBoundingBox bbox = StructureBoundingBox
                .getComponentToAddBoundingBox(par3, par4, par5, 0, 0, 0, 9, 9, 10, par6);
