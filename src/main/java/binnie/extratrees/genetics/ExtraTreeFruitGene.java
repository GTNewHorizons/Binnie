...
import binnie.extratrees.item.FoodItems;
...
public enum ExtraTreeFruitGene implements IAlleleFruit, IFruitProvider {
    ...
    public static void init() {
        ...
        ExtraTreeFruitGene.Crabapple.addProduct(FoodItems.Items.Crabapple.get(1), 1.0f);
        ExtraTreeFruitGene.Crabapple.setFamily(familyPome);
        ExtraTreeFruitGene.Orange.addProduct(FoodItems.Items.Orange.get(1), 1.0f);
        ExtraTreeFruitGene.Orange.setFamily(familyCitrus);
        ExtraTreeFruitGene.Manderin.addProduct(FoodItems.Items.Manderin.get(1), 1.0f);
        ExtraTreeFruitGene.Manderin.setFamily(familyCitrus);
        ExtraTreeFruitGene.Tangerine.addProduct(FoodItems.Items.Tangerine.get(1), 1.0f);
        ExtraTreeFruitGene.Tangerine.setFamily(familyCitrus);
        ExtraTreeFruitGene.Satsuma.addProduct(FoodItems.Items.Satsuma.get(1), 1.0f);
        ExtraTreeFruitGene.Satsuma.setFamily(familyCitrus);
        ExtraTreeFruitGene.KeyLime.addProduct(FoodItems.Items.KeyLime.get(1), 1.0f);
        ExtraTreeFruitGene.KeyLime.setFamily(familyCitrus);
        ExtraTreeFruitGene.Lime.addProduct(FoodItems.Items.Lime.get(1), 1.0f);
        ExtraTreeFruitGene.Lime.setFamily(familyCitrus);
        ExtraTreeFruitGene.FingerLime.addProduct(FoodItems.Items.FingerLime.get(1), 1.0f);
        ExtraTreeFruitGene.FingerLime.setFamily(familyCitrus);
        ExtraTreeFruitGene.Pomelo.addProduct(FoodItems.Items.Pomelo.get(1), 1.0f);
        ExtraTreeFruitGene.Pomelo.setFamily(familyCitrus);
        ExtraTreeFruitGene.Grapefruit.addProduct(FoodItems.Items.Grapefruit.get(1), 1.0f);
        ExtraTreeFruitGene.Grapefruit.setFamily(familyCitrus);
        ExtraTreeFruitGene.Kumquat.addProduct(FoodItems.Items.Kumquat.get(1), 1.0f);
        ExtraTreeFruitGene.Kumquat.setFamily(familyCitrus);
        ExtraTreeFruitGene.Citron.addProduct(FoodItems.Items.Citron.get(1), 1.0f);
        ExtraTreeFruitGene.Citron.setFamily(familyCitrus);
        ExtraTreeFruitGene.BuddhaHand.addProduct(FoodItems.Items.BuddhaHand.get(1), 1.0f);
        ExtraTreeFruitGene.BuddhaHand.setFamily(familyCitrus);
        ExtraTreeFruitGene.Blackthorn.addProduct(FoodItems.Items.Blackthorn.get(1), 1.0f);
        ExtraTreeFruitGene.Blackthorn.setFamily(familyPrune);
        ExtraTreeFruitGene.CherryPlum.addProduct(FoodItems.Items.CherryPlum.get(1), 1.0f);
        ExtraTreeFruitGene.CherryPlum.setFamily(familyPrune);
        ExtraTreeFruitGene.Peach.addProduct(FoodItems.Items.Peach.get(1), 1.0f);
        ExtraTreeFruitGene.Peach.setFamily(familyPrune);
        ExtraTreeFruitGene.Nectarine.addProduct(FoodItems.Items.Nectarine.get(1), 1.0f);
        ExtraTreeFruitGene.Nectarine.setFamily(familyPrune);
        ExtraTreeFruitGene.Apricot.addProduct(FoodItems.Items.Apricot.get(1), 1.0f);
        ExtraTreeFruitGene.Apricot.setFamily(familyPrune);
        ExtraTreeFruitGene.Almond.addProduct(FoodItems.Items.Almond.get(1), 1.0f);
        ExtraTreeFruitGene.Almond.setFamily(familyPrune);
        ExtraTreeFruitGene.WildCherry.addProduct(FoodItems.Items.WildCherry.get(1), 1.0f);
        ExtraTreeFruitGene.WildCherry.setFamily(familyPrune);
        ExtraTreeFruitGene.SourCherry.addProduct(FoodItems.Items.SourCherry.get(1), 1.0f);
        ExtraTreeFruitGene.SourCherry.setFamily(familyPrune);
        ExtraTreeFruitGene.BlackCherry.addProduct(FoodItems.Items.BlackCherry.get(1), 1.0f);
        ExtraTreeFruitGene.BlackCherry.setFamily(familyPrune);
        ExtraTreeFruitGene.Hazelnut.addProduct(FoodItems.Items.Hazelnut.get(1), 1.0f);
        ExtraTreeFruitGene.Hazelnut.setFamily(familyNuts);
        ExtraTreeFruitGene.Butternut.addProduct(FoodItems.Items.Butternut.get(1), 1.0f);
        ExtraTreeFruitGene.Butternut.setFamily(familyNuts);
        ExtraTreeFruitGene.Beechnut.addProduct(FoodItems.Items.Beechnut.get(1), 1.0f);
        ExtraTreeFruitGene.Beechnut.setFamily(familyNuts);
        ExtraTreeFruitGene.Pecan.addProduct(FoodItems.Items.Pecan.get(1), 1.0f);
        ExtraTreeFruitGene.Pecan.setFamily(familyNuts);
        ExtraTreeFruitGene.Banana.addProduct(FoodItems.Items.Banana.get(2), 1.0f);
        ExtraTreeFruitGene.Banana.setFamily(familyJungle);
        ExtraTreeFruitGene.RedBanana.addProduct(FoodItems.Items.RedBanana.get(2), 1.0f);
        ExtraTreeFruitGene.RedBanana.setFamily(familyJungle);
        ExtraTreeFruitGene.Plantain.addProduct(FoodItems.Items.Plantain.get(2), 1.0f);
        ExtraTreeFruitGene.Plantain.setFamily(familyJungle);
        ExtraTreeFruitGene.BrazilNut.addProduct(FoodItems.Items.BrazilNut.get(4), 1.0f);
        ExtraTreeFruitGene.BrazilNut.setFamily(familyNuts);
        ExtraTreeFruitGene.Fig.addProduct(FoodItems.Items.Fig.get(1), 1.0f);
        ExtraTreeFruitGene.Fig.setFamily(familyPrune);
        ExtraTreeFruitGene.Acorn.addProduct(FoodItems.Items.Acorn.get(1), 1.0f);
        ExtraTreeFruitGene.Acorn.setFamily(familyNuts);
        ExtraTreeFruitGene.Elderberry.addProduct(FoodItems.Items.Elderberry.get(1), 1.0f);
        ExtraTreeFruitGene.Elderberry.setFamily(familyPrune);
        ExtraTreeFruitGene.Olive.addProduct(FoodItems.Items.Olive.get(1), 1.0f);
        ExtraTreeFruitGene.Olive.setFamily(familyPrune);
        ExtraTreeFruitGene.GingkoNut.addProduct(FoodItems.Items.GingkoNut.get(1), 1.0f);
        ExtraTreeFruitGene.GingkoNut.setFamily(familyNuts);
        ExtraTreeFruitGene.Coffee.addProduct(FoodItems.Items.Coffee.get(1), 1.0f);
        ExtraTreeFruitGene.Coffee.setFamily(familyJungle);
        ExtraTreeFruitGene.Pear.addProduct(FoodItems.Items.Pear.get(1), 1.0f);
        ExtraTreeFruitGene.Pear.setFamily(familyPome);
        ExtraTreeFruitGene.OsangeOsange.addProduct(FoodItems.Items.OsangeOrange.get(1), 1.0f);
        ExtraTreeFruitGene.OsangeOsange.setFamily(familyPome);
        ExtraTreeFruitGene.Clove.addProduct(FoodItems.Items.Clove.get(1), 1.0f);
        ExtraTreeFruitGene.Clove.setFamily(familyNuts);
        ExtraTreeFruitGene.Blackcurrant.addProduct(FoodItems.Items.Blackcurrant.get(2), 1.0f);
        ExtraTreeFruitGene.Blackcurrant.setFamily(familyBerry);
        ExtraTreeFruitGene.Redcurrant.addProduct(FoodItems.Items.Redcurrant.get(2), 1.0f);
        ExtraTreeFruitGene.Redcurrant.setFamily(familyBerry);
        ExtraTreeFruitGene.Blackberry.addProduct(FoodItems.Items.Blackberry.get(2), 1.0f);
        ExtraTreeFruitGene.Blackberry.setFamily(familyBerry);
        ExtraTreeFruitGene.Raspberry.addProduct(FoodItems.Items.Raspberry.get(2), 1.0f);
        ExtraTreeFruitGene.Raspberry.setFamily(familyBerry);
        ExtraTreeFruitGene.Blueberry.addProduct(FoodItems.Items.Blueberry.get(2), 1.0f);
        ExtraTreeFruitGene.Blueberry.setFamily(familyBerry);
        ExtraTreeFruitGene.Cranberry.addProduct(FoodItems.Items.Cranberry.get(2), 1.0f);
        ExtraTreeFruitGene.Cranberry.setFamily(familyBerry);
        ExtraTreeFruitGene.Juniper.addProduct(FoodItems.Items.Juniper.get(2), 1.0f);
        ExtraTreeFruitGene.Juniper.setFamily(familyBerry);
        ExtraTreeFruitGene.Gooseberry.addProduct(FoodItems.Items.Gooseberry.get(2), 1.0f);
        ExtraTreeFruitGene.Gooseberry.setFamily(familyBerry);
        ExtraTreeFruitGene.GoldenRaspberry.addProduct(FoodItems.Items.GoldenRaspberry.get(2), 1.0f);
        ExtraTreeFruitGene.GoldenRaspberry.setFamily(familyBerry);
        ExtraTreeFruitGene.Coconut.addProduct(FoodItems.Items.Coconut.get(1), 1.0f);
        ExtraTreeFruitGene.Coconut.setFamily(familyJungle);
        ExtraTreeFruitGene.Cashew.addProduct(FoodItems.Items.Cashew.get(1), 1.0f);
        ExtraTreeFruitGene.Cashew.setFamily(familyJungle);
        ExtraTreeFruitGene.Avacado.addProduct(FoodItems.Items.Avacado.get(1), 1.0f);
        ExtraTreeFruitGene.Avacado.setFamily(familyJungle);
        ExtraTreeFruitGene.Nutmeg.addProduct(FoodItems.Items.Nutmeg.get(1), 1.0f);
        ExtraTreeFruitGene.Nutmeg.setFamily(familyJungle);
        ExtraTreeFruitGene.Allspice.addProduct(FoodItems.Items.Allspice.get(1), 1.0f);
        ExtraTreeFruitGene.Allspice.setFamily(familyJungle);
        ExtraTreeFruitGene.Chilli.addProduct(FoodItems.Items.Chilli.get(1), 1.0f);
        ExtraTreeFruitGene.Chilli.setFamily(familyJungle);
        ExtraTreeFruitGene.StarAnise.addProduct(FoodItems.Items.StarAnise.get(1), 1.0f);
        ExtraTreeFruitGene.StarAnise.setFamily(familyJungle);
        ExtraTreeFruitGene.Mango.addProduct(FoodItems.Items.Mango.get(1), 1.0f);
        ExtraTreeFruitGene.Mango.setFamily(familyPome);
        ExtraTreeFruitGene.Starfruit.addProduct(FoodItems.Items.Starfruit.get(1), 1.0f);
        ExtraTreeFruitGene.Starfruit.setFamily(familyJungle);
        ExtraTreeFruitGene.Candlenut.addProduct(FoodItems.Items.Candlenut.get(1), 1.0f);
    ...
    public String getNameOfFruit() {
        ...
        for (ItemStack stack : products.keySet()) {
            if (stack.getItem() == ETItems.itemFood) {
                return ETItems.itemFood.getName(stack.getItemDamage());
            }
        }
        return "NoFruit";
    }
