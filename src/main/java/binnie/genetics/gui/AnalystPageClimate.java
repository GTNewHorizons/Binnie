...
public class AnalystPageClimate extends ControlAnalystPage {
    ...
    public AnalystPageClimate(IWidget parent, IArea area, IIndividual ind) {
        ...
        if (ind instanceof IButterfly) {
            tempTol = ((IAlleleTolerance) ind.getGenome()
                    .getActiveAllele(EnumButterflyChromosome.TEMPERATURE_TOLERANCE)).getValue();
    ...
    protected void createTemperatureBar(IWidget parent, float x, float y, float w, float h, EnumTemperature value,
            EnumTolerance tol) {
    ...
    protected void createHumidity(IWidget parent, float x, float y, float w, float h, EnumHumidity value,
            EnumTolerance tol) {
