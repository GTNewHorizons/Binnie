    ...
    public AnalystPageGrowth(IWidget parent, IArea area, IIndividual ind) {
        ...
        if (ind instanceof ITree) {
            ...
            String alleleName = Binnie.Genetics.treeBreedingSystem.getAlleleName(
                    ...
                    ind.getGenome().getActiveAllele(EnumTreeChromosome.HEIGHT));
            ...
            y += 12;
            alleleName = Binnie.Genetics.treeBreedingSystem
                    .getAlleleName(EnumTreeChromosome.GIRTH, ind.getGenome().getActiveAllele(EnumTreeChromosome.GIRTH));
            new ControlTextCentered(
                    this,
                    y,
            ...
            new ControlTextCentered(
                    this,
                    y,
                    EnumChatFormatting.ITALIC + tree.getGenome().getGrowthProvider().getDescription())
                            .setColor(getColor());
